...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineRenderParamsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "sceneCullingMask", _s_set_sceneCullingMask);
        ...
        static int _g_get_overrideSceneCullingMask(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.RenderParams gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.overrideSceneCullingMask);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_overrideSceneCullingMask(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.RenderParams gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                gen_to_be_invoked.overrideSceneCullingMask = LuaAPI.lua_toboolean(L, 2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_sceneCullingMask(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.RenderParams gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                gen_to_be_invoked.sceneCullingMask = LuaAPI.lua_touint64(L, 2);
