...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineSortingLayerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "onLayerAdded", _g_get_onLayerAdded);
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "onLayerRemoved", _g_get_onLayerRemoved);
            
			Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "onLayerAdded", _s_set_onLayerAdded);
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "onLayerRemoved", _s_set_onLayerRemoved);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_onLayerAdded(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, UnityEngine.SortingLayer.onLayerAdded);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_onLayerRemoved(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, UnityEngine.SortingLayer.onLayerRemoved);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_onLayerAdded(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    UnityEngine.SortingLayer.onLayerAdded = translator.GetDelegate<UnityEngine.SortingLayer.LayerCallback>(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_onLayerRemoved(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    UnityEngine.SortingLayer.onLayerRemoved = translator.GetDelegate<UnityEngine.SortingLayer.LayerCallback>(L, 1);
