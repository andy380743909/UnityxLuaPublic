...
namespace XLua.CSObjectWrap
{
    ...
    public class CFX_AutoStopLoopedEffectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(CFX_AutoStopLoopedEffect);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new CFX_AutoStopLoopedEffect();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to CFX_AutoStopLoopedEffect constructor!");
        ...
        static int _g_get_effectDuration(RealStatePtr L)
        {
		    try {
                ...
                CFX_AutoStopLoopedEffect gen_to_be_invoked = (CFX_AutoStopLoopedEffect)translator.FastGetCSObj(L, 1);
