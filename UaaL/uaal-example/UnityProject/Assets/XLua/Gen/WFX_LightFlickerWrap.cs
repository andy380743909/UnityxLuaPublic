...
namespace XLua.CSObjectWrap
{
    ...
    public class WFX_LightFlickerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(WFX_LightFlicker);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new WFX_LightFlicker();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to WFX_LightFlicker constructor!");
        ...
        static int _g_get_time(RealStatePtr L)
        {
		    try {
                ...
                WFX_LightFlicker gen_to_be_invoked = (WFX_LightFlicker)translator.FastGetCSObj(L, 1);
