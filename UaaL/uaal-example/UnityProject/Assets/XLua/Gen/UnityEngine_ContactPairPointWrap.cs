...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineContactPairPointWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.ContactPairPoint);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(UnityEngine.ContactPairPoint));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.ContactPairPoint constructor!");
        ...
        static int _g_get_position(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ContactPairPoint gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
