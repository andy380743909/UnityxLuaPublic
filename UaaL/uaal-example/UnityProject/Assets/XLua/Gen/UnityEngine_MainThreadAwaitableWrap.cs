...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineMainThreadAwaitableWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.MainThreadAwaitable);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(UnityEngine.MainThreadAwaitable));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.MainThreadAwaitable constructor!");
        ...
        static int _m_GetAwaiter(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.MainThreadAwaitable gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
