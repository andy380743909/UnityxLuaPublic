...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEnginePhysicsMaterialWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.PhysicsMaterial);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new UnityEngine.PhysicsMaterial();
				...
				if(LuaAPI.lua_gettop(L) == 2 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING))
				{
					...
					var gen_ret = new UnityEngine.PhysicsMaterial(_name);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.PhysicsMaterial constructor!");
        ...
        static int _g_get_bounciness(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.PhysicsMaterial gen_to_be_invoked = (UnityEngine.PhysicsMaterial)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_frictionCombine(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.PhysicsMaterial gen_to_be_invoked = (UnityEngine.PhysicsMaterial)translator.FastGetCSObj(L, 1);
                UnityEngine.PhysicsMaterialCombine gen_value;translator.Get(L, 2, out gen_value);
