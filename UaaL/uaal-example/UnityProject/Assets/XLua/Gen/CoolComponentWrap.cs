...
namespace XLua.CSObjectWrap
{
    ...
    public class CoolComponentWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(CoolComponent);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to CoolComponent constructor!");
        ...
        static int _m_ConstructFromXML(RealStatePtr L)
        {
		    try {
                ...
                CoolComponent gen_to_be_invoked = (CoolComponent)translator.FastGetCSObj(L, 1);
