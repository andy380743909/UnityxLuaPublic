...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEnginePhysicsSceneWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 1, 16, 0, 0);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "RunSimulationStages", _m_RunSimulationStages);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "InterpolateBodies", _m_InterpolateBodies);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ResetInterpolationPoses", _m_ResetInterpolationPoses);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_RunSimulationStages(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<UnityEngine.SimulationStage>(L, 3)&& translator.Assignable<UnityEngine.SimulationOption>(L, 4)) 
                {
                    float _step = (float)LuaAPI.lua_tonumber(L, 2);
                    UnityEngine.SimulationStage _stages;translator.Get(L, 3, out _stages);
                    UnityEngine.SimulationOption _options;translator.Get(L, 4, out _options);
                    
                    gen_to_be_invoked.RunSimulationStages( _step, _stages, _options );
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<UnityEngine.SimulationStage>(L, 3)) 
                {
                    float _step = (float)LuaAPI.lua_tonumber(L, 2);
                    UnityEngine.SimulationStage _stages;translator.Get(L, 3, out _stages);
                    
                    gen_to_be_invoked.RunSimulationStages( _step, _stages );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.PhysicsScene.RunSimulationStages!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_InterpolateBodies(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.InterpolateBodies(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ResetInterpolationPoses(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.ResetInterpolationPoses(  );
