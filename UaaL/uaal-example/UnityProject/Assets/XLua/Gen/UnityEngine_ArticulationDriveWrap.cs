...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineArticulationDriveWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "driveType", _g_get_driveType);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "driveType", _s_set_driveType);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_driveType(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.ArticulationDrive gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.Push(L, gen_to_be_invoked.driveType);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_driveType(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.ArticulationDrive gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                UnityEngine.ArticulationDriveType gen_value;translator.Get(L, 2, out gen_value);
				gen_to_be_invoked.driveType = gen_value;
