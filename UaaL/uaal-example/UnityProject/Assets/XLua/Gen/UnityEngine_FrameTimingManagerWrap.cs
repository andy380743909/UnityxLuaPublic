...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineFrameTimingManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "IsFeatureEnabled", _m_IsFeatureEnabled_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_IsFeatureEnabled_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = UnityEngine.FrameTimingManager.IsFeatureEnabled(  );
