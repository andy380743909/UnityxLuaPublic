    ...
    public class UnityEngineGraphicsWrap 
    {
        ...
        static int _m_SetRenderTarget_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Rendering.GraphicsTexture>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<UnityEngine.CubemapFace>(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    UnityEngine.Rendering.GraphicsTexture _rt = (UnityEngine.Rendering.GraphicsTexture)translator.GetObject(L, 1, typeof(UnityEngine.Rendering.GraphicsTexture));
                    int _mipLevel = LuaAPI.xlua_tointeger(L, 2);
                    UnityEngine.CubemapFace _face;translator.Get(L, 3, out _face);
                    int _depthSlice = LuaAPI.xlua_tointeger(L, 4);
        ...
        static int _m_CopyTexture_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Rendering.GraphicsTexture>(L, 1)&& translator.Assignable<UnityEngine.Rendering.GraphicsTexture>(L, 2)) 
                {
                    UnityEngine.Rendering.GraphicsTexture _src = (UnityEngine.Rendering.GraphicsTexture)translator.GetObject(L, 1, typeof(UnityEngine.Rendering.GraphicsTexture));
                    UnityEngine.Rendering.GraphicsTexture _dst = (UnityEngine.Rendering.GraphicsTexture)translator.GetObject(L, 2, typeof(UnityEngine.Rendering.GraphicsTexture));
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Rendering.GraphicsTexture>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<UnityEngine.Rendering.GraphicsTexture>(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    UnityEngine.Rendering.GraphicsTexture _src = (UnityEngine.Rendering.GraphicsTexture)translator.GetObject(L, 1, typeof(UnityEngine.Rendering.GraphicsTexture));
                    int _srcElement = LuaAPI.xlua_tointeger(L, 2);
                    UnityEngine.Rendering.GraphicsTexture _dst = (UnityEngine.Rendering.GraphicsTexture)translator.GetObject(L, 3, typeof(UnityEngine.Rendering.GraphicsTexture));
                    int _dstElement = LuaAPI.xlua_tointeger(L, 4);
                ...
                if(gen_param_count == 6&& translator.Assignable<UnityEngine.Rendering.GraphicsTexture>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<UnityEngine.Rendering.GraphicsTexture>(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6)) 
                {
                    UnityEngine.Rendering.GraphicsTexture _src = (UnityEngine.Rendering.GraphicsTexture)translator.GetObject(L, 1, typeof(UnityEngine.Rendering.GraphicsTexture));
                    int _srcElement = LuaAPI.xlua_tointeger(L, 2);
                    int _srcMip = LuaAPI.xlua_tointeger(L, 3);
                    UnityEngine.Rendering.GraphicsTexture _dst = (UnityEngine.Rendering.GraphicsTexture)translator.GetObject(L, 4, typeof(UnityEngine.Rendering.GraphicsTexture));
                    int _dstElement = LuaAPI.xlua_tointeger(L, 5);
                    int _dstMip = LuaAPI.xlua_tointeger(L, 6);
                ...
                if(gen_param_count == 12&& translator.Assignable<UnityEngine.Rendering.GraphicsTexture>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 7)&& translator.Assignable<UnityEngine.Rendering.GraphicsTexture>(L, 8)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 9)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 10)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 11)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 12)) 
                {
                    UnityEngine.Rendering.GraphicsTexture _src = (UnityEngine.Rendering.GraphicsTexture)translator.GetObject(L, 1, typeof(UnityEngine.Rendering.GraphicsTexture));
                    int _srcElement = LuaAPI.xlua_tointeger(L, 2);
                    int _srcMip = LuaAPI.xlua_tointeger(L, 3);
                    ...
                    int _srcWidth = LuaAPI.xlua_tointeger(L, 6);
                    int _srcHeight = LuaAPI.xlua_tointeger(L, 7);
                    UnityEngine.Rendering.GraphicsTexture _dst = (UnityEngine.Rendering.GraphicsTexture)translator.GetObject(L, 8, typeof(UnityEngine.Rendering.GraphicsTexture));
                    int _dstElement = LuaAPI.xlua_tointeger(L, 9);
                    int _dstMip = LuaAPI.xlua_tointeger(L, 10);
                    int _dstX = LuaAPI.xlua_tointeger(L, 11);
                    int _dstY = LuaAPI.xlua_tointeger(L, 12);
        ...
        static int _m_Blit_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Texture>(L, 1)&& translator.Assignable<UnityEngine.Rendering.GraphicsTexture>(L, 2)) 
                {
                    UnityEngine.Texture _source = (UnityEngine.Texture)translator.GetObject(L, 1, typeof(UnityEngine.Texture));
                    UnityEngine.Rendering.GraphicsTexture _dest = (UnityEngine.Rendering.GraphicsTexture)translator.GetObject(L, 2, typeof(UnityEngine.Rendering.GraphicsTexture));
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Texture>(L, 1)&& translator.Assignable<UnityEngine.Rendering.GraphicsTexture>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    UnityEngine.Texture _source = (UnityEngine.Texture)translator.GetObject(L, 1, typeof(UnityEngine.Texture));
                    UnityEngine.Rendering.GraphicsTexture _dest = (UnityEngine.Rendering.GraphicsTexture)translator.GetObject(L, 2, typeof(UnityEngine.Rendering.GraphicsTexture));
                    int _sourceDepthSlice = LuaAPI.xlua_tointeger(L, 3);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Texture>(L, 1)&& translator.Assignable<UnityEngine.Rendering.GraphicsTexture>(L, 2)&& translator.Assignable<UnityEngine.Material>(L, 3)) 
                {
                    UnityEngine.Texture _source = (UnityEngine.Texture)translator.GetObject(L, 1, typeof(UnityEngine.Texture));
                    UnityEngine.Rendering.GraphicsTexture _dest = (UnityEngine.Rendering.GraphicsTexture)translator.GetObject(L, 2, typeof(UnityEngine.Rendering.GraphicsTexture));
                    UnityEngine.Material _mat = (UnityEngine.Material)translator.GetObject(L, 3, typeof(UnityEngine.Material));
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Texture>(L, 1)&& translator.Assignable<UnityEngine.Rendering.GraphicsTexture>(L, 2)&& translator.Assignable<UnityEngine.Material>(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    UnityEngine.Texture _source = (UnityEngine.Texture)translator.GetObject(L, 1, typeof(UnityEngine.Texture));
                    UnityEngine.Rendering.GraphicsTexture _dest = (UnityEngine.Rendering.GraphicsTexture)translator.GetObject(L, 2, typeof(UnityEngine.Rendering.GraphicsTexture));
                    UnityEngine.Material _mat = (UnityEngine.Material)translator.GetObject(L, 3, typeof(UnityEngine.Material));
                ...
                if(gen_param_count == 5&& translator.Assignable<UnityEngine.Texture>(L, 1)&& translator.Assignable<UnityEngine.Rendering.GraphicsTexture>(L, 2)&& translator.Assignable<UnityEngine.Material>(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    UnityEngine.Texture _source = (UnityEngine.Texture)translator.GetObject(L, 1, typeof(UnityEngine.Texture));
                    UnityEngine.Rendering.GraphicsTexture _dest = (UnityEngine.Rendering.GraphicsTexture)translator.GetObject(L, 2, typeof(UnityEngine.Rendering.GraphicsTexture));
                    UnityEngine.Material _mat = (UnityEngine.Material)translator.GetObject(L, 3, typeof(UnityEngine.Material));
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Texture>(L, 1)&& translator.Assignable<UnityEngine.Rendering.GraphicsTexture>(L, 2)&& translator.Assignable<UnityEngine.Vector2>(L, 3)&& translator.Assignable<UnityEngine.Vector2>(L, 4)) 
                {
                    UnityEngine.Texture _source = (UnityEngine.Texture)translator.GetObject(L, 1, typeof(UnityEngine.Texture));
                    UnityEngine.Rendering.GraphicsTexture _dest = (UnityEngine.Rendering.GraphicsTexture)translator.GetObject(L, 2, typeof(UnityEngine.Rendering.GraphicsTexture));
                    UnityEngine.Vector2 _scale;translator.Get(L, 3, out _scale);
                ...
                if(gen_param_count == 6&& translator.Assignable<UnityEngine.Texture>(L, 1)&& translator.Assignable<UnityEngine.Rendering.GraphicsTexture>(L, 2)&& translator.Assignable<UnityEngine.Vector2>(L, 3)&& translator.Assignable<UnityEngine.Vector2>(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6)) 
                {
                    UnityEngine.Texture _source = (UnityEngine.Texture)translator.GetObject(L, 1, typeof(UnityEngine.Texture));
                    UnityEngine.Rendering.GraphicsTexture _dest = (UnityEngine.Rendering.GraphicsTexture)translator.GetObject(L, 2, typeof(UnityEngine.Rendering.GraphicsTexture));
                    UnityEngine.Vector2 _scale;translator.Get(L, 3, out _scale);
        ...
        static int _m_BlitMultiTap_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count >= 3&& translator.Assignable<UnityEngine.Texture>(L, 1)&& translator.Assignable<UnityEngine.Rendering.GraphicsTexture>(L, 2)&& translator.Assignable<UnityEngine.Material>(L, 3)&& (LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 4) || translator.Assignable<UnityEngine.Vector2>(L, 4))) 
                {
                    UnityEngine.Texture _source = (UnityEngine.Texture)translator.GetObject(L, 1, typeof(UnityEngine.Texture));
                    UnityEngine.Rendering.GraphicsTexture _dest = (UnityEngine.Rendering.GraphicsTexture)translator.GetObject(L, 2, typeof(UnityEngine.Rendering.GraphicsTexture));
                    UnityEngine.Material _mat = (UnityEngine.Material)translator.GetObject(L, 3, typeof(UnityEngine.Material));
                ...
                if(gen_param_count >= 4&& translator.Assignable<UnityEngine.Texture>(L, 1)&& translator.Assignable<UnityEngine.Rendering.GraphicsTexture>(L, 2)&& translator.Assignable<UnityEngine.Material>(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& (LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 5) || translator.Assignable<UnityEngine.Vector2>(L, 5))) 
                {
                    UnityEngine.Texture _source = (UnityEngine.Texture)translator.GetObject(L, 1, typeof(UnityEngine.Texture));
                    UnityEngine.Rendering.GraphicsTexture _dest = (UnityEngine.Rendering.GraphicsTexture)translator.GetObject(L, 2, typeof(UnityEngine.Rendering.GraphicsTexture));
                    UnityEngine.Material _mat = (UnityEngine.Material)translator.GetObject(L, 3, typeof(UnityEngine.Material));
