...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineGradientWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "colorSpace", _g_get_colorSpace);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "colorSpace", _s_set_colorSpace);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_colorSpace(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.Gradient gen_to_be_invoked = (UnityEngine.Gradient)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.colorSpace);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_colorSpace(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.Gradient gen_to_be_invoked = (UnityEngine.Gradient)translator.FastGetCSObj(L, 1);
                UnityEngine.ColorSpace gen_value;translator.Get(L, 2, out gen_value);
				gen_to_be_invoked.colorSpace = gen_value;
