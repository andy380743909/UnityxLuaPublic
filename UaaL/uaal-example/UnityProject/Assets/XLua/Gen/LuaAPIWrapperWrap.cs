...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaAPIWrapperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaAPIWrapper);
        ...
        {
            return LuaAPI.luaL_error(L, "LuaAPIWrapper does not have a constructor!");
        }
        ...
        static int _m_DontDestroyOnLoad_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    LuaAPIWrapper.DontDestroyOnLoad( _gameObject );
