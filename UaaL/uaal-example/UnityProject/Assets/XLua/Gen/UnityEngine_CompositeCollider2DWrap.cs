...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineCompositeCollider2DWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 4, 8, 6);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GenerateGeometry", _m_GenerateGeometry);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetCompositedColliders", _m_GetCompositedColliders);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetCompositedColliders(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    System.Collections.Generic.List<UnityEngine.Collider2D> _colliders = (System.Collections.Generic.List<UnityEngine.Collider2D>)translator.GetObject(L, 2, typeof(System.Collections.Generic.List<UnityEngine.Collider2D>));
                        ...
                        var gen_ret = gen_to_be_invoked.GetCompositedColliders( _colliders );
