...
namespace XLua.CSObjectWrap
{
    ...
    public class CFX_Demo_RandomDirWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(CFX_Demo_RandomDir);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new CFX_Demo_RandomDir();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to CFX_Demo_RandomDir constructor!");
        ...
        static int _g_get_min(RealStatePtr L)
        {
		    try {
                ...
                CFX_Demo_RandomDir gen_to_be_invoked = (CFX_Demo_RandomDir)translator.FastGetCSObj(L, 1);
