...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEnginePhysicsScene2DWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 1, 17, 2, 0);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "subStepCount", _g_get_subStepCount);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "subStepLostTime", _g_get_subStepLostTime);
        ...
        static int _m_Simulate(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    float _deltaTime = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.Simulate( _deltaTime );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                ...
                {
                    float _deltaTime = (float)LuaAPI.lua_tonumber(L, 2);
                    int _simulationLayers = LuaAPI.xlua_tointeger(L, 3);
                    
                        var gen_ret = gen_to_be_invoked.Simulate( _deltaTime, _simulationLayers );
                        LuaAPI.lua_pushboolean(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.PhysicsScene2D.Simulate!");
        ...
        static int _m_GetRayIntersection(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 5&& translator.Assignable<UnityEngine.Ray>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<System.Collections.Generic.List<UnityEngine.RaycastHit2D>>(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    UnityEngine.Ray _ray;translator.Get(L, 2, out _ray);
                    float _distance = (float)LuaAPI.lua_tonumber(L, 3);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Ray>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<System.Collections.Generic.List<UnityEngine.RaycastHit2D>>(L, 4)) 
                {
                    UnityEngine.Ray _ray;translator.Get(L, 2, out _ray);
                    float _distance = (float)LuaAPI.lua_tonumber(L, 3);
                    System.Collections.Generic.List<UnityEngine.RaycastHit2D> _results = (System.Collections.Generic.List<UnityEngine.RaycastHit2D>)translator.GetObject(L, 4, typeof(System.Collections.Generic.List<UnityEngine.RaycastHit2D>));
        ...
        static int _m_OverlapCollider_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector2>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<UnityEngine.Collider2D>(L, 3)&& translator.Assignable<System.Collections.Generic.List<UnityEngine.Collider2D>>(L, 4)) 
                {
                    UnityEngine.Vector2 _position;translator.Get(L, 1, out _position);
                    float _angle = (float)LuaAPI.lua_tonumber(L, 2);
                    UnityEngine.Collider2D _collider = (UnityEngine.Collider2D)translator.GetObject(L, 3, typeof(UnityEngine.Collider2D));
                    System.Collections.Generic.List<UnityEngine.Collider2D> _results = (System.Collections.Generic.List<UnityEngine.Collider2D>)translator.GetObject(L, 4, typeof(System.Collections.Generic.List<UnityEngine.Collider2D>));
                    
                        var gen_ret = UnityEngine.PhysicsScene2D.OverlapCollider( _position, _angle, _collider, _results );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
                ...
                if(gen_param_count == 5&& translator.Assignable<UnityEngine.Vector2>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<UnityEngine.Collider2D>(L, 3)&& translator.Assignable<UnityEngine.ContactFilter2D>(L, 4)&& translator.Assignable<System.Collections.Generic.List<UnityEngine.Collider2D>>(L, 5)) 
                {
                    UnityEngine.Vector2 _position;translator.Get(L, 1, out _position);
                    float _angle = (float)LuaAPI.lua_tonumber(L, 2);
                    UnityEngine.Collider2D _collider = (UnityEngine.Collider2D)translator.GetObject(L, 3, typeof(UnityEngine.Collider2D));
                    ...
                    System.Collections.Generic.List<UnityEngine.Collider2D> _results = (System.Collections.Generic.List<UnityEngine.Collider2D>)translator.GetObject(L, 5, typeof(System.Collections.Generic.List<UnityEngine.Collider2D>));
                        ...
                        var gen_ret = UnityEngine.PhysicsScene2D.OverlapCollider( _position, _angle, _collider, _contactFilter, _results );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_subStepCount(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.PhysicsScene2D gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.subStepCount);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_subStepLostTime(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.PhysicsScene2D gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                LuaAPI.lua_pushnumber(L, gen_to_be_invoked.subStepLostTime);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
