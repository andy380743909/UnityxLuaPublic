...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineLightProbesWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 2, 6, 1);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetPositionsSelf", _m_GetPositionsSelf);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetPositionsSelf", _m_SetPositionsSelf);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "countSelf", _g_get_countSelf);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "cellCount", _g_get_cellCount);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "cellCountSelf", _g_get_cellCountSelf);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "GetSharedLightProbesForScene", _m_GetSharedLightProbesForScene_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "GetInstantiatedLightProbesForScene", _m_GetInstantiatedLightProbesForScene_xlua_st_);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "lightProbesUpdated", _e_lightProbesUpdated);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetSharedLightProbesForScene_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    UnityEngine.SceneManagement.Scene _scene;translator.Get(L, 1, out _scene);
                        ...
                        var gen_ret = UnityEngine.LightProbes.GetSharedLightProbesForScene( _scene );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetInstantiatedLightProbesForScene_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    UnityEngine.SceneManagement.Scene _scene;translator.Get(L, 1, out _scene);
                        ...
                        var gen_ret = UnityEngine.LightProbes.GetInstantiatedLightProbesForScene( _scene );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetPositionsSelf(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetPositionsSelf(  );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetPositionsSelf(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    bool _checkForDuplicatePositions = LuaAPI.lua_toboolean(L, 3);
                    
                        var gen_ret = gen_to_be_invoked.SetPositionsSelf( _positions, _checkForDuplicatePositions );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_countSelf(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.LightProbes gen_to_be_invoked = (UnityEngine.LightProbes)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.countSelf);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_cellCountSelf(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.LightProbes gen_to_be_invoked = (UnityEngine.LightProbes)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.cellCountSelf);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_lightProbesUpdated(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
				...
				if (gen_param_count == 2 && LuaAPI.xlua_is_eq_str(L, 1, "+")) {
					UnityEngine.LightProbes.lightProbesUpdated += gen_delegate;
					return 0;
				} 
			...
			return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.LightProbes.lightProbesUpdated!");
        }
