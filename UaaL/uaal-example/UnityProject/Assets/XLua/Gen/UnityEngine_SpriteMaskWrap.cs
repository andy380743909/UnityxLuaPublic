...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineSpriteMaskWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "maskSource", _g_get_maskSource);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "maskSource", _s_set_maskSource);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_maskSource(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.SpriteMask gen_to_be_invoked = (UnityEngine.SpriteMask)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.maskSource);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_maskSource(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.SpriteMask gen_to_be_invoked = (UnityEngine.SpriteMask)translator.FastGetCSObj(L, 1);
                UnityEngine.SpriteMask.MaskSource gen_value;translator.Get(L, 2, out gen_value);
				gen_to_be_invoked.maskSource = gen_value;
