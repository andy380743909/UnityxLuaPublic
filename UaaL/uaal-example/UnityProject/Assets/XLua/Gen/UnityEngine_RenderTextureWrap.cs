...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineRenderTextureWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 10, 23, 20);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ApplyDynamicScale", _m_ApplyDynamicScale);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "useDynamicScaleExplicit", _g_get_useDynamicScaleExplicit);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "useDynamicScaleExplicit", _s_set_useDynamicScaleExplicit);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ApplyDynamicScale(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.ApplyDynamicScale(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_useDynamicScaleExplicit(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.RenderTexture gen_to_be_invoked = (UnityEngine.RenderTexture)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.useDynamicScaleExplicit);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_useDynamicScaleExplicit(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.RenderTexture gen_to_be_invoked = (UnityEngine.RenderTexture)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.useDynamicScaleExplicit = LuaAPI.lua_toboolean(L, 2);
