...
namespace XLua.CSObjectWrap
{
    ...
    public class CFX_LightIntensityFadeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(CFX_LightIntensityFade);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "finalIntensity", _g_get_finalIntensity);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "finalIntensity", _s_set_finalIntensity);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new CFX_LightIntensityFade();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to CFX_LightIntensityFade constructor!");
        ...
        static int _g_get_duration(RealStatePtr L)
        {
		    try {
                ...
                CFX_LightIntensityFade gen_to_be_invoked = (CFX_LightIntensityFade)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_finalIntensity(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                CFX_LightIntensityFade gen_to_be_invoked = (CFX_LightIntensityFade)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushnumber(L, gen_to_be_invoked.finalIntensity);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_finalIntensity(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                CFX_LightIntensityFade gen_to_be_invoked = (CFX_LightIntensityFade)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.finalIntensity = (float)LuaAPI.lua_tonumber(L, 2);
