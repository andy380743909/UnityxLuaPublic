...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineDebugWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 20, 4, 2);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "RetrieveStartupLogs", _m_RetrieveStartupLogs_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "CheckIntegrity", _m_CheckIntegrity_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "IsValidationLevelEnabled", _m_IsValidationLevelEnabled_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_RetrieveStartupLogs_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = UnityEngine.Debug.RetrieveStartupLogs(  );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_CheckIntegrity_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.IntegrityCheckLevel _level;translator.Get(L, 1, out _level);
                    
                        var gen_ret = UnityEngine.Debug.CheckIntegrity( _level );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_IsValidationLevelEnabled_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.ValidationLevel _level;translator.Get(L, 1, out _level);
                    
                        var gen_ret = UnityEngine.Debug.IsValidationLevelEnabled( _level );
