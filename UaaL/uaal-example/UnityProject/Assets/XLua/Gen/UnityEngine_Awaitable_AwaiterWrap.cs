...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAwaitableAwaiterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.Awaitable.Awaiter);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(UnityEngine.Awaitable.Awaiter));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Awaitable.Awaiter constructor!");
        ...
        static int _m_OnCompleted(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Awaitable.Awaiter gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
