...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineRectIntWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 1, 7, 14, 12);
        ...
        static int __EqMeta(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<UnityEngine.RectInt>(L, 1) && translator.Assignable<UnityEngine.RectInt>(L, 2))
				{
					UnityEngine.RectInt leftside;translator.Get(L, 1, out leftside);
					UnityEngine.RectInt rightside;translator.Get(L, 2, out rightside);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to right hand of == operator, need UnityEngine.RectInt!");
        ...
        static int _m_Equals(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.RectInt>(L, 2)) 
                {
                    UnityEngine.RectInt _other;translator.Get(L, 2, out _other);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.RectInt.Equals!");
        ...
        static int _g_get_zero(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, UnityEngine.RectInt.zero);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
