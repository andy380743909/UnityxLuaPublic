...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineLODGroupWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "lastLODBillboard", _g_get_lastLODBillboard);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "lastLODBillboard", _s_set_lastLODBillboard);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_lastLODBillboard(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.LODGroup gen_to_be_invoked = (UnityEngine.LODGroup)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.lastLODBillboard);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_lastLODBillboard(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.LODGroup gen_to_be_invoked = (UnityEngine.LODGroup)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.lastLODBillboard = LuaAPI.lua_toboolean(L, 2);
