...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineColliderHitWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.ColliderHit);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(UnityEngine.ColliderHit));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.ColliderHit constructor!");
        ...
        static int _g_get_instanceID(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ColliderHit gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
