...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineHingeJointWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "extendedLimits", _g_get_extendedLimits);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "useAcceleration", _g_get_useAcceleration);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "extendedLimits", _s_set_extendedLimits);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "useSpring", _s_set_useSpring);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "useAcceleration", _s_set_useAcceleration);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_extendedLimits(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.HingeJoint gen_to_be_invoked = (UnityEngine.HingeJoint)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.extendedLimits);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_useAcceleration(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.HingeJoint gen_to_be_invoked = (UnityEngine.HingeJoint)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.useAcceleration);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_extendedLimits(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.HingeJoint gen_to_be_invoked = (UnityEngine.HingeJoint)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.extendedLimits = LuaAPI.lua_toboolean(L, 2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_useAcceleration(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.HingeJoint gen_to_be_invoked = (UnityEngine.HingeJoint)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.useAcceleration = LuaAPI.lua_toboolean(L, 2);
