...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineJoint2DWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "breakAction", _g_get_breakAction);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "breakAction", _s_set_breakAction);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_breakAction(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.Joint2D gen_to_be_invoked = (UnityEngine.Joint2D)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.breakAction);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_breakAction(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.Joint2D gen_to_be_invoked = (UnityEngine.Joint2D)translator.FastGetCSObj(L, 1);
                UnityEngine.JointBreakAction2D gen_value;translator.Get(L, 2, out gen_value);
				gen_to_be_invoked.breakAction = gen_value;
