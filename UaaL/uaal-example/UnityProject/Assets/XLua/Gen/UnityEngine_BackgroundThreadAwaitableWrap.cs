...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineBackgroundThreadAwaitableWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.BackgroundThreadAwaitable);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(UnityEngine.BackgroundThreadAwaitable));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.BackgroundThreadAwaitable constructor!");
        ...
        static int _m_GetAwaiter(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.BackgroundThreadAwaitable gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
