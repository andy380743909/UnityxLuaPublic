...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineRenderSettingsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "customReflectionTexture", _g_get_customReflectionTexture);
            ...
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "customReflectionTexture", _s_set_customReflectionTexture);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_customReflectionTexture(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, UnityEngine.RenderSettings.customReflectionTexture);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_customReflectionTexture(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    UnityEngine.RenderSettings.customReflectionTexture = (UnityEngine.Texture)translator.GetObject(L, 1, typeof(UnityEngine.Texture));
