...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineCubemapWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 10, 8, 1);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 5 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<UnityEngine.Experimental.Rendering.DefaultFormat>(L, 3) && translator.Assignable<UnityEngine.Experimental.Rendering.TextureCreationFlags>(L, 4) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5))
				{
					int _width = LuaAPI.xlua_tointeger(L, 2);
					UnityEngine.Experimental.Rendering.DefaultFormat _format;translator.Get(L, 3, out _format);
					UnityEngine.Experimental.Rendering.TextureCreationFlags _flags;translator.Get(L, 4, out _flags);
				...
				if(LuaAPI.lua_gettop(L) == 5 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<UnityEngine.TextureFormat>(L, 3) && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4) && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 5))
				{
					int _width = LuaAPI.xlua_tointeger(L, 2);
					UnityEngine.TextureFormat _textureFormat;translator.Get(L, 3, out _textureFormat);
					bool _mipChain = LuaAPI.lua_toboolean(L, 4);
					bool _createUninitialized = LuaAPI.lua_toboolean(L, 5);
					
					var gen_ret = new UnityEngine.Cubemap(_width, _textureFormat, _mipChain, _createUninitialized);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 5 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<UnityEngine.TextureFormat>(L, 3) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4) && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 5))
				{
					int _width = LuaAPI.xlua_tointeger(L, 2);
					UnityEngine.TextureFormat _format;translator.Get(L, 3, out _format);
					int _mipCount = LuaAPI.xlua_tointeger(L, 4);
					...
					var gen_ret = new UnityEngine.Cubemap(_width, _format, _mipCount, _createUninitialized);
					translator.Push(L, gen_ret);
        ...
        static int _m_CopyPixels(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 6&& translator.Assignable<UnityEngine.Texture>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& translator.Assignable<UnityEngine.CubemapFace>(L, 5)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6)) 
                {
                    UnityEngine.Texture _src = (UnityEngine.Texture)translator.GetObject(L, 2, typeof(UnityEngine.Texture));
                    int _srcElement = LuaAPI.xlua_tointeger(L, 3);
                    int _srcMip = LuaAPI.xlua_tointeger(L, 4);
                    UnityEngine.CubemapFace _dstFace;translator.Get(L, 5, out _dstFace);
                    int _dstMip = LuaAPI.xlua_tointeger(L, 6);
                    
                    gen_to_be_invoked.CopyPixels( _src, _srcElement, _srcMip, _dstFace, _dstMip );
                    
                    
                    
                    return 0;
                }
                if(gen_param_count == 12&& translator.Assignable<UnityEngine.Texture>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 7)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 8)&& translator.Assignable<UnityEngine.CubemapFace>(L, 9)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 10)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 11)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 12)) 
                {
                    UnityEngine.Texture _src = (UnityEngine.Texture)translator.GetObject(L, 2, typeof(UnityEngine.Texture));
                    int _srcElement = LuaAPI.xlua_tointeger(L, 3);
                    int _srcMip = LuaAPI.xlua_tointeger(L, 4);
                    ...
                    UnityEngine.CubemapFace _dstFace;translator.Get(L, 9, out _dstFace);
                    int _dstMip = LuaAPI.xlua_tointeger(L, 10);
                    int _dstX = LuaAPI.xlua_tointeger(L, 11);
                    int _dstY = LuaAPI.xlua_tointeger(L, 12);
                    
                    gen_to_be_invoked.CopyPixels( _src, _srcElement, _srcMip, _srcX, _srcY, _srcWidth, _srcHeight, _dstFace, _dstMip, _dstX, _dstY );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Cubemap.CopyPixels!");
