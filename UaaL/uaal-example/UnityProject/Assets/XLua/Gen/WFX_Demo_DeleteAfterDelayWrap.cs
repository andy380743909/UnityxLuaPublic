...
namespace XLua.CSObjectWrap
{
    ...
    public class WFX_Demo_DeleteAfterDelayWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(WFX_Demo_DeleteAfterDelay);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new WFX_Demo_DeleteAfterDelay();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to WFX_Demo_DeleteAfterDelay constructor!");
        ...
        static int _g_get_delay(RealStatePtr L)
        {
		    try {
                ...
                WFX_Demo_DeleteAfterDelay gen_to_be_invoked = (WFX_Demo_DeleteAfterDelay)translator.FastGetCSObj(L, 1);
