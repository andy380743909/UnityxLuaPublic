...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineHingeJoint2DWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 1, 9, 5);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "useConnectedAnchor", _g_get_useConnectedAnchor);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "useConnectedAnchor", _s_set_useConnectedAnchor);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_useConnectedAnchor(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.HingeJoint2D gen_to_be_invoked = (UnityEngine.HingeJoint2D)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.useConnectedAnchor);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_useConnectedAnchor(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.HingeJoint2D gen_to_be_invoked = (UnityEngine.HingeJoint2D)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.useConnectedAnchor = LuaAPI.lua_toboolean(L, 2);
