...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineComputeShaderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 24, 3, 2);
        ...
        static int _m_SetRayTracingAccelerationStructure(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<UnityEngine.Rendering.RayTracingAccelerationStructure>(L, 4)) 
                {
                    int _kernelIndex = LuaAPI.xlua_tointeger(L, 2);
                    int _nameID = LuaAPI.xlua_tointeger(L, 3);
                    UnityEngine.Rendering.RayTracingAccelerationStructure _accelerationStructure = (UnityEngine.Rendering.RayTracingAccelerationStructure)translator.GetObject(L, 4, typeof(UnityEngine.Rendering.RayTracingAccelerationStructure));
                    
                    gen_to_be_invoked.SetRayTracingAccelerationStructure( _kernelIndex, _nameID, _accelerationStructure );
                    
                    
                    
                    return 0;
                }
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& translator.Assignable<UnityEngine.Rendering.RayTracingAccelerationStructure>(L, 4)) 
                {
                    int _kernelIndex = LuaAPI.xlua_tointeger(L, 2);
                    string _name = LuaAPI.lua_tostring(L, 3);
                    UnityEngine.Rendering.RayTracingAccelerationStructure _accelerationStructure = (UnityEngine.Rendering.RayTracingAccelerationStructure)translator.GetObject(L, 4, typeof(UnityEngine.Rendering.RayTracingAccelerationStructure));
                    
                    gen_to_be_invoked.SetRayTracingAccelerationStructure( _kernelIndex, _name, _accelerationStructure );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.ComputeShader.SetRayTracingAccelerationStructure!");
